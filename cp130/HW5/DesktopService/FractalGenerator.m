...
const				int			kMaximumIterations		=	2000; //300;
	// the number of iterations will influence the coloring of the fractal
...
- (void) setRGBPixelData:(unsigned char*)pixelBuffer forX:(double)x_value Y:(double)y_value;
{
	...
	// a specified limit after a maximum number of iterations
	// this an approximation of determining if recursive function 
	// goes to infinity for an infinite number of iterations of the loop
	//
